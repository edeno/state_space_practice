...
This roadmap provides one strict implementation queue for all nine plans in docs/plans, with:
...
| 4 | 2026-04-03-adaptive-decoder.md | PARTIAL | Medium | 2 weeks | Position Decoding |
| 5 | 2026-04-04-covariate-driven-drift.md | PARTIAL | Medium | 2-3 weeks | Cross-Session Drift baseline APIs |
| 6 | 2026-04-04-spatial-value-model.md | PARTIAL | Medium-High | 2-3 weeks | Multinomial Choice complete |
| 7 | 2026-04-03-joint-learning-drift.md | SPECULATIVE | High | 3+ weeks | Adaptive + Covariate + Multinomial pieces |
| 8 | 2026-04-03-cross-region-coupling.md | SPECULATIVE | High | 3+ weeks | Switching point-process stability + oscillator block abstractions |

## Why This Order

- Orders 1-3 maximize fast wins using existing infrastructure and reduce unknowns.
- Orders 4-6 are dependency-driven integrations that become tractable after the core models exist.
- Orders 7-8 are research-grade integration efforts and should only start once lower-risk blocks are validated.
...
### Order 5: Covariate-Driven Drift
...
### Order 7: Joint Learning + Drift (Prototype First)
...
### Order 8: Cross-Region Coupling (Two-Region MVP First)
...
- roadmap-order-4-adaptive-decoder
- roadmap-order-5-covariate-drift
- roadmap-order-6-spatial-value
- roadmap-order-7-joint-learning-drift
- roadmap-order-8-cross-region-coupling
